...
?>
  ...
  if(isset($_POST['Submitsem2']))
  {
     ...
     $query="select * from semester6 where roll_num='$roll_no'";
	 $result=@mysql_query($query);
	 $rows=@mysql_num_rows($result);
	 if($rows==1)
	 { $update="update semester6 set subject1='$subject1',subject2='$subject2',subject3='$subject3',subject4='$subject4',subject5='$subject5',subject6='$subject6',subject7='$subject7',subject8='$subject8' where roll_num='$roll_no'";
	 @MYSQL_QUERY($update);
